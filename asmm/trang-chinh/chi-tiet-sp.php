    ...
    <div class="container" style="margin-top: 20px;">
        <div class="row">
            <div class="col-md-7" style="padding-left: 0px;">
                <div class="chuyen">
                    <p><a href="index.php"> <span>TRANG CHỦ </span></a> / CHI TIẾT SẢN PHẨM</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 10px;">
        <div class="row">
            ...
            <div class="col-md-4" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../asmm/css/admin/images/products/<?= $hinh ?>" alt="" style="width:100%;">
                </div>
            </div>
            <div class="col-md-5">
                <div class="thongtinsp">
                    <ul>
                        ...
                        <li class="gu" style="margin-top: 20px;"> <img src="../../asmm/css/chi-tiet-sp/img/ttt.png" alt=""> </li>
                        ...
                        <li class="soluong1" style="margin-top: 27px;">
                            ...
                            if (!isset($_SESSION['user'])) {
                            ?>
                                <a href="../../asmm/tai-khoan/dang-nhap.php"><button style="margin-top:-5px;" class="btn btn-dark">ĐĂNG NHẬP ĐỂ MUA HÀNG</button></a>
                            <?php } else { ?>
        ...
        <div class="row">
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                        <div class="item">
                            <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img style="width: 200px" src="../../asmm/css/admin/images/products/<?= $hinh ?>" alt="ds"><span class='cung-loai'><?= $ten_loai ?></span></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
