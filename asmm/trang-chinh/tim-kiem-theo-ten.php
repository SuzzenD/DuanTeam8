    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                ?>
                    <div class="sanpham">
                        <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img src="../../asmm/css/admin/images/products/<?= $hinh ?>" alt=""></a>
                        <div class="text">
                            <div class="price">
                                <?= $don_gia ?> VNĐ
                            </div>
        ...
        <div class="row">
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                        <div class="item">
                            <a href="chi-tiet-sp.php?ma_hh=<?= $ma_hh ?>"><img style="width: 200px" src="../../asmm/css/admin/images/products/<?= $hinh ?>" alt="ds"></a>
                        </div>
                    <?php } ?>
                </div>
            </div>
