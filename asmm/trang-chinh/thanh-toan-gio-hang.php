        ...
        <div class="row">
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
                <div class="login">
                  ...
                  ?>
                  <a href="../../asmm/tai-khoan/dang-nhap.php"><p><strong>ĐĂNG NHẬP / ĐĂNG KÍ</strong></p></a> 
                    <?php }else{ ?>
                        <a href="../../asmm/tai-khoan/thong-tin-tk.php"><p><strong>Xin chào <?=$_SESSION['user']['ho_ten']?></strong></p></a>
                  <?php } ?>
                </div>
            ...
            <div class="col-md-4" style="background-color: rgb(54, 54, 54);text-align: center">
                ...
                <ul>
                        <li style="list-style: none;"><p style="color: rgb(212, 212, 212);font-size: 14px;">GIỎ HÀNG</p></li>
                       <a href="danh-sach-gio-hang.php"><li style="list-style: none;"><i class="fa fa-shopping-basket" style="font-size:28px;color:rgb(255, 255, 255)"></i></li></a> 
                    </ul>
                </div>
            </div>
        </div>
...
">
                <div class="chuyen">
                    <p><a href="index.php"> <span>TRANG CHỦ </span></a> / THANH TOÁN</p>
                </div>
            </div>
        </div>
    </div>
