            ...
            <div class="auth-form-outer">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($mat_khau != $mat_khau2) {
                        $errors['fail'] = 'Mật khẩu không khớp!';
                    } elseif (strlen($mat_khau) < 8) {
                        $errors['fail'] = 'Mật khẩu phải có ít nhất 8 ký tự!';
                    } else {
                        // Sử dụng password_hash để mã hóa mật khẩu mới
                        $hashed_password = password_hash($mat_khau, PASSWORD_DEFAULT);

                        $errors['success'] = 'Đổi mật khẩu thành công! Chuyển sang sau 1s';
                        $result = $confirm->getPass($hashed_password, $_SESSION['mail']);
                ...
                <form class="login-form" method="post">
                    <div class="input-icon">
                        <input type="password" class="auth-form-input" placeholder="Mật khẩu mới" name="mat_khau">
                        <span class="focus-input100" data-placeholder="&#xf18e;"></span>
                    </div>
                    <div class="input-icon">
                        <input type="password" class="auth-form-input" placeholder="Xác nhận khẩu mới" name="mat_khau2">
                        <span class="focus-input100" data-placeholder="&#xf18e;"></span>
                    </div>
                    <tr>
                        ...
                        <?php if (isset($errors['success'])) : ?>
                            <p style="color: green;"><?php echo $errors['success']; ?></p>
                        <?php endif; ?>
                    </tr>
