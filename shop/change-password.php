            ...
            <div class="auth-form-outer">
                ...
                <form class="login-form" method="post">
                    ...
                    <div class="input-icon">
                        <input type="password" class="auth-form-input" placeholder="Mật khẩu cũ" name="mat_khau">
                        <span class="focus-input100" data-placeholder="&#xf18e;"></span>
                    </div>
                    <div class="input-icon">
                        <input type="password" class="auth-form-input" placeholder="Mật khẩu mới" name="mat_khau2">
                        <span class="focus-input100" data-placeholder="&#xf18e;"></span>
                    </div>
                    <div class="input-icon">
