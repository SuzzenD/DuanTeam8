            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="index.html"><img src="images/logofeg.avif" alt="FlatShop"></a></div>
                  </div>
                     ...
                     <div class="header_bottom">
                        <ul class="option">
                           <li id="search" class="search">
                              <form><input class="search-submit" type="submit" value=""><input class="search-input" placeholder="Nhập từ khóa cần tìm..." type="text" value="" name="search"></form>
                           </li>
                           <li class="option-cart">
                              <a href="cart.html" class="cart-icon">Giỏ <span class="cart_no">02</span></a>
                        ...
                        <div class="navbar-collapse collapse">
                           <ul class="nav navbar-nav">
                              ...
                              <li><a href="productgird.html">Sản phẩm</a></li>
                              <li class="dropdown">
                                 <a href="productgird.html" class="dropdown-toggle" data-toggle="dropdown">Thời trang</a>
                                 <div class="dropdown-menu mega-menu">
                                    <div class="row">
                                       <div class="col-md-6 col-sm-6">
                                          <ul class="mega-menu-links">
                                             <li><a href="productgird.html">Bộ sưu tập</a></li>
                                             <li><a href="productgird.html">Áo khoác</a></li>
                                             <li><a href="productgird.html">Nón</a></li>
                                          </ul>
                                       </div>
                                    </div>
                                 </div>
