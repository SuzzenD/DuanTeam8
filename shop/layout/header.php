        ...
        <div class="container">
           <div class="row">
              <div class="col-md-2 col-sm-2">
                 <div class="logo"><a href="index.html"><img src="images/image-removebg-preview (2).png" alt="FlatShop"></a></div>
              </div>
                 ...
                 <div class="header_bottom">
                    <ul class="option">
                       ...
                       <li class="option-cart">
                          <a href="#" class="cart-icon">Giỏ <span class="cart_no">02</span></a>
                    ...
                    <div class="navbar-collapse collapse">
                       <ul class="nav navbar-nav">
                          <li class="active dropdown">
                             ...
                             <div class="dropdown-menu">
                                <ul class="mega-menu-links">
                                   ...
                                   <li><a href="productlitst.html">Danh sách</a></li>
                          ...
                          <li><a href="productgird.html">Đàn ông</a></li>
                          <li><a href="productlitst.html">Phụ nữ</a></li>
                          <li class="dropdown">
